  ...
  )
{
  ...
  ReadBufferSize = 512;
  ReadBuffer     = AllocateZeroPool (ReadBufferSize);
  ...
  )
{
  ...
  //
  // Since ReceiveFifo and Timeout cannot be chagned ensure that they are the
  // correct value
  //
  Timeout          = 16;
  ReceiveFifoDepth = MAX_BUFFER_SIZE;
  //
  ...
  UsbSerialDevice->LastSettings.Timeout          = 16;
  UsbSerialDevice->LastSettings.ReceiveFifoDepth = MAX_BUFFER_SIZE;
